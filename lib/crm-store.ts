...
export const DEFAULT_TECH_STACK: TechStackCMS[] = [
  { id: "tech-flutter", name: "Flutter", category: "Mobile Framework", image: "/assets/img/teckstack/flutter.svg", description: "Cross-platform mobile apps for iOS and Android", status: "active" },
  { id: "tech-dart", name: "Dart", category: "Programming Language", image: "/assets/img/teckstack/dart.svg", description: "Client-optimized language for fast apps", status: "active" },
  { id: "tech-kotlin", name: "Kotlin", category: "Mobile & JVM", image: "/assets/img/teckstack/kotlin.svg", description: "Modern native Android and cross-platform development", status: "active" },
  { id: "tech-android", name: "Android", category: "Mobile OS", image: "/assets/img/teckstack/android.svg", description: "Native Android OS mobile application ecosystem", status: "active" },
  { id: "tech-android-studio", name: "Android Studio", category: "IDE & Tooling", image: "/assets/img/teckstack/android-studio.svg", description: "Official IDE for Android development", status: "active" },
  { id: "tech-ios", name: "iOS & Swift", category: "Mobile OS", image: "/assets/img/teckstack/ios.svg", description: "Apple iOS native mobile ecosystem", status: "active" },
  { id: "tech-react", name: "React", category: "Frontend Library", image: "/assets/img/teckstack/react.svg", description: "Modern UI library for web & native apps", status: "active" },
  { id: "tech-nextjs", name: "Next.js", category: "Fullstack Framework", image: "/assets/img/teckstack/nextjs.svg", description: "React framework for production SSR & static sites", status: "active" },
  { id: "tech-vitejs", name: "Vite", category: "Frontend Tooling", image: "/assets/img/teckstack/vitejs.svg", description: "Next generation fast frontend tooling", status: "active" },
  { id: "tech-vue", name: "Vue.js", category: "Frontend Framework", image: "/assets/img/teckstack/vue.svg", description: "Progressive JavaScript frontend framework", status: "active" },
  { id: "tech-angularjs", name: "AngularJS", category: "Frontend Framework", image: "/assets/img/teckstack/angularjs.svg", description: "Structured client-side web framework", status: "active" },
  { id: "tech-nodejs", name: "Node.js", category: "Backend Runtime", image: "/assets/img/teckstack/nodejs.svg", description: "High-throughput asynchronous JavaScript runtime", status: "active" },
  { id: "tech-express-js", name: "Express.js", category: "Backend Framework", image: "/assets/img/teckstack/express-js.svg", description: "Fast, unopinionated minimalist web framework", status: "active" },
  { id: "tech-django", name: "Django", category: "Backend Framework", image: "/assets/img/teckstack/django.svg", description: "High-level Python web framework", status: "active" },
  { id: "tech-python", name: "Python", category: "Programming Language", image: "/assets/img/teckstack/python.svg", description: "General purpose & AI/ML backend programming", status: "active" },
  { id: "tech-laravel", name: "Laravel", category: "Backend Framework", image: "/assets/img/teckstack/laravel.svg", description: "Elegant PHP framework for web artisans", status: "active" },
  { id: "tech-javascript", name: "JavaScript", category: "Programming Language", image: "/assets/img/teckstack/javascript.svg", description: "Core language of modern web development", status: "active" },
  { id: "tech-java", name: "Java", category: "Enterprise & Backend", image: "/assets/img/teckstack/java.svg", description: "Enterprise backend and Android software", status: "active" },
  { id: "tech-cplusplus", name: "C++", category: "Systems Engineering", image: "/assets/img/teckstack/cplusplus.svg", description: "High-performance systems programming", status: "active" },
  { id: "tech-firebase", name: "Firebase", category: "Cloud & Database", image: "/assets/img/teckstack/firebase.svg", description: "Realtime database, authentication & cloud functions", status: "active" },
  { id: "tech-mongodb", name: "MongoDB", category: "NoSQL Database", image: "/assets/img/teckstack/mongodb.svg", description: "Flexible document-based distributed database", status: "active" },
  { id: "tech-postgresql", name: "PostgreSQL", category: "Relational Database", image: "/assets/img/teckstack/postgresql.svg", description: "Advanced open-source relational database", status: "active" },
  { id: "tech-microsoftsqlserver", name: "MS SQL Server", category: "Enterprise Database", image: "/assets/img/teckstack/microsoftsqlserver.svg", description: "Microsoft enterprise relational database", status: "active" },
  { id: "tech-sqlite", name: "SQLite", category: "Embedded Database", image: "/assets/img/teckstack/sqlite.svg", description: "Self-contained serverless SQL database engine", status: "active" },
  { id: "tech-appwrite", name: "Appwrite", category: "Backend-as-a-Service", image: "/assets/img/teckstack/appwrite.svg", description: "Secure open-source backend for developers", status: "active" },
  { id: "tech-tailwindcss", name: "Tailwind CSS", category: "Styling Framework", image: "/assets/img/teckstack/tailwindcss.svg", description: "Utility-first CSS framework for modern design", status: "active" },
  { id: "tech-bootstrap", name: "Bootstrap", category: "UI Framework", image: "/assets/img/teckstack/bootstrap.svg", description: "Responsive mobile-first frontend toolkit", status: "active" },
  { id: "tech-css3", name: "CSS3", category: "Styling & Animations", image: "/assets/img/teckstack/css3.svg", description: "Modern web layout and cascading style sheets", status: "active" },
  { id: "tech-html5", name: "HTML5", category: "Web Standards", image: "/assets/img/teckstack/html5.svg", description: "Semantic markup and modern web capabilities", status: "active" },
  { id: "tech-threejs", name: "Three.js", category: "3D & WebGL Graphics", image: "/assets/img/teckstack/threejs.svg", description: "Interactive 3D computer graphics in browser", status: "active" },
  { id: "tech-stripe", name: "Stripe", category: "Payment Gateway", image: "/assets/img/teckstack/stripe.svg", description: "Global online payment processing infrastructure", status: "active" },
  { id: "tech-jwt", name: "JWT", category: "Security & Auth", image: "/assets/img/teckstack/jwt.svg", description: "JSON Web Tokens for secure authentication", status: "active" },
  { id: "tech-auth0", name: "Auth0", category: "Identity & Security", image: "/assets/img/teckstack/auth0.svg", description: "Universal authentication & identity platform", status: "active" },
  { id: "tech-git", name: "Git", category: "Version Control", image: "/assets/img/teckstack/git.svg", description: "Distributed version control and collaboration", status: "active" },
  { id: "tech-github", name: "GitHub", category: "DevOps & CI/CD", image: "/assets/img/teckstack/github.svg", description: "Cloud repository hosting & automated workflows", status: "active" },
  { id: "tech-postman", name: "Postman", category: "API Platform", image: "/assets/img/teckstack/postman.svg", description: "API development, testing, and lifecycle platform", status: "active" },
  { id: "tech-figma", name: "Figma", category: "UI/UX Design", image: "/assets/img/teckstack/figma.svg", description: "Collaborative interface design & prototyping", status: "active" },
  { id: "tech-wordpress", name: "WordPress", category: "CMS & Web", image: "/assets/img/teckstack/wordpress.svg", description: "Content management & custom web engineering", status: "active" },
  { id: "tech-play-console", name: "Play Console", category: "App Deployment", image: "/assets/img/teckstack/play-console.svg", description: "Google Play Store publishing & distribution", status: "active" },
  { id: "tech-microsoft", name: "Microsoft Stack", category: "Cloud & Solutions", image: "/assets/img/teckstack/microsoft.svg", description: "Enterprise Microsoft technology ecosystem", status: "active" },
  { id: "tech-architecture", name: "System Architecture", category: "Engineering Design", image: "/assets/img/teckstack/architecture.svg", description: "Microservices & distributed system architecture", status: "active" },
  { id: "tech-visualstudiocode", name: "VS Code", category: "Developer Tools", image: "/assets/img/teckstack/visualstudiocode.svg", description: "Advanced extensible code editor", status: "active" },
  { id: "tech-jquery", name: "jQuery", category: "Legacy Web Tooling", image: "/assets/img/teckstack/jquery.svg", description: "Fast feature-rich client-side JavaScript library", status: "active" },
];
...
if (!global._crmStore || !Array.isArray(global._crmStore.projects) || global._crmStore.projects.length < 5) {
